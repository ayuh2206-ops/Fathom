...
type NotificationSeverity = "critical" | "success" | "info" | "warning"
...
export function Header({ userName, userEmail }: HeaderProps) {
    ...
    const markAllRead = () => {
        setNotifications((prev: NotificationItem[]) => prev.map((notification) => ({ ...notification, read: true })))
    }
                    ...
                    <DropdownMenuTrigger asChild>
                        <Button variant="ghost" className="relative h-8 w-8 rounded-full">
                            <Avatar className="h-8 w-8">
                                ...
                                <AvatarFallback className="bg-ocean text-white">{avatarFallback}</AvatarFallback>
                            </Avatar>
                        </Button>
                    </DropdownMenuTrigger>
